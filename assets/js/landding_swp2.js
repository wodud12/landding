        ...
        void 0 !== n &&
          ...
          (w(e[r]) && w(i[r])
            ? i[r].__swiper__
              ...
              : S(e[r], i[r])
            : !w(e[r]) && w(i[r])
            ? ((e[r] = {}), i[r].__swiper__ ? (e[r] = i[r]) : S(e[r], i[r]))
            : (e[r] = i[r]));
      }
    }
  }
...
function $(e) {
  ...
  if (!i.isMoved) {
    if (
      (T && S && s.loopFix({ direction: s.swipeDirection }),
...
function j(e) {
  ...
  if (p > n.longSwipesMs) {
    ...
    "next" === t.swipeDirection &&
      (T >= n.longSwipesRatio
        ? t.slideTo(n.rewind && t.isEnd ? g : f + S)
        : t.slideTo(f)),
    ...
    (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
      ? r.target === t.navigation.nextEl
        ? t.slideTo(f + S)
        : t.slideTo(f)
      : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : f + S),
    ...
    loop: {
      ...
      loopFix: function (e) {
        ...
        const L = S ? Math.ceil(p.length / m.grid.rows) : p.length,
          A = (S ? p[n].column : n) + (v && void 0 === r ? -g / 2 + 0.5 : 0);
        if (A < T) {
          C = Math.max(T - A, w);
      ...
      t.params.parallax.enabled &&
        (function (e) {
          ...
          t.isElement && n.push(...i.querySelectorAll(r)),
            n.forEach((t) => {
              let s =
                parseInt(t.getAttribute("data-swiper-parallax-duration"), 10) ||
                e;
